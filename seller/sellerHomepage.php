...
<body>
    ...
    ?>
        ...
        <tr>
		    <td><a href="sellerItemDetails.php?item_id=<?php echo $row['item_id']; ?>"><img src="/fyp2/<?php echo $row['item_image_path']?>" width="80" height="80" class="view-listing-image"></td>
		</tr>
		<tr>
            <td><a href="sellerItemDetails.php?item_id=<?php echo $row['item_id']; ?> " class="view-listing-text01"><?=$row['item_name'] ?> </td>
		</tr>
		<tr>
            <td>$<?=$row['price'] ?></td>
        </tr>
