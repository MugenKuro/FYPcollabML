                ...
                <div class="account-setting-container04">
                    <form class="account-setting-form">
                        ...
                        <div class="account-setting-container13">
                            <button type="button" class="account-setting-button button"  onclick="window.location='sellerEditSettings.php'">
                                <span class="account-setting-text43">
                                    <span>Edit login Details</span>
                                    <br />
                                </span>
                            </button>
                            <button type="button" class="account-setting-button1 button" onclick="window.location='sellerHomepage.php'">
