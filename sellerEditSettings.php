            ...
            <div class="seller-settings-container01">
                ...
                <div class="seller-settings-container04">
                    <form class="seller-settings-form" action="sellerEditSettings.php" method="POST">
					    ...
					    <span><input type="file" class="form-control" id="profile_image" placeholder="Image" name="profile_image" value=""></span>
                        </div>
                        <div class="seller-settings-container05">
                        ...
                        <div class="seller-settings-container05">
                            ...
                            <div class="seller-settings-container06">
                                <input type="text" placeholder="sellername" name = "seller_name" class="seller-settings-textinput input" />
                                </input>
                            </div>
                        </div>
                        <div class="seller-settings-container05">
                            ...
                            <div class="seller-settings-container06">
                                <input type="text" placeholder="description" name = "description" class="seller-settings-textinput input" />
                                </input>
                            </div>
                        </div>
                        <div class="seller-settings-container05">
                            ...
                            <div class="seller-settings-container06">
                                <input type="text" placeholder="address" name = "pick_up_address" class="seller-settings-textinput input" />
                                </input>
                            </div>
                        </div>
                        <div class="seller-settings-container05">
                        <span class="seller-settings-text03">payment QR</span>
					    <span><input type="file" class="form-control" id="payment_QR" placeholder="QR Code" name="payment_QR" value=""></span>
                        </div>
                        <div class="seller-settings-container05">
                            <span class="seller-settings-text03">
                                <span>Email</span>
                            ...
                            <div class="seller-settings-container06">
                                <input type="text" placeholder="email" name = "email" class="seller-settings-textinput input" />
                                </input>
                            </div>
                        </div>
                        <div class="seller-settings-container11">
                        <input type="submit" name="updateLogin" class="seller-settings-button button" value="Submit"></input>
                    
                            <button type="button" class="seller-settings-button1 button" onclick="window.location='sellerAccountSetting.php'">
                    ...
                    ?>
                    <form method ="POST" action="sellerEditSettings.php" style="margin:auto;">
                    <input type="submit" name="requestDeactivation" value="Request Deactivation" class="seller-settings-button2 button">
                    </input>
                    </form>
                </div>
            </div>
