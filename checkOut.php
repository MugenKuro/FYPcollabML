    ...
    <div>
        <div class="check-out-container">
            <div class="check-out-container1">
                <h1>Scan and pay</h1>
                <img src="./images/paynow_qr_1.jpg" alt="image" class="check-out-image" />
                <button type="button" class="check-out-button button" onclick="window.location='paymentSuccess.php'">
                    <span class="check-out-text1">
                        <span>Done</span>
                        <br />
                    </span>
                </button>
